...
class TestSearchBook:
    ...
    def test_local_search(self):
        ...
        keyword = ""
        code, book_list = self.d_op.local_search(keyword, store_id=self.store_id)
        assert code == 914, f"Expected 200, but got {code}"

    def test_local_search_without_store_id(self):
        """Test for local search functionality without providing a store_id."""
        keyword = "三毛"
